...
public class MenuButton extends JButton {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gradient = new GradientPaint(0, 0, new Color(22,166,66), 0,getHeight(),new Color(35,166,97));
        g2.setPaint(gradient);
        g2.setFont(new Font("sansserif",1,30));
        
        // Draw the default button shape
        Area defaultArea = createShape();
        g2.fill(defaultArea);
        g2.draw(defaultArea);
        
        // Draw the effect on top of the default shape when the button is pressed
